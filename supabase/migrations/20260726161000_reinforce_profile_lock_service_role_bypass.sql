/*
# Re-assert profile privilege lock with robust service-role detection

Ensures service role bypass is evaluated from claims/auth.role reliably and
keeps strict protected-field lock for non-admin users.
*/
